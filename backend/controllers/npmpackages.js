...
exports.createPackage = (req, res, next) => {
    ...
    npmpackages.save().then((npmpackage) => {
...
exports.getPackages = (req, res, next) => {
    Npmpackages.find({userId: req.user}).then((npmpackages) => {
...
exports.getPackage =  (req, res, next) => {
    Npmpackages.findOne({_id: req.params.id}).then((npmpackage) => {
...
exports.editPackage = (req, res, next) => {
    ...
    Npmpackages.updateOne({_id: req.params.id}, npmpackages).then(() => {
...
exports.deletePackage = (req, res, next) => {
    // a ameliorer QD IL y aura des users car on doit supprimé only les packages de lutilisateur concerné 
    Npmpackages.deleteOne({_id: req.params.id}).then(() => {
